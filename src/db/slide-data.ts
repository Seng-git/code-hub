...
export const intermediate: IData[] = [
  ...
  {
    id: 10,
    image: require('../assets/bai10.png'),
...
export const advanced: IData[] = [
  ...
  {
    id: 23,
    image: require('../assets/proj4.png'),
